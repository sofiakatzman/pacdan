...
FunnyAnimation::FunnyAnimation() : screen(Screen::getInstance()),
								   ...
								   labyrinth(Labyrinth::getInstance())
{
	...
	pacmanName = Screen::getTextSurface(Screen::getLargeFont(), "Pacdan", Constants::YELLOW_COLOR);
	blinkyName = Screen::getTextSurface(Screen::getLargeFont(), "Penaronqui", Constants::BLINKY_COLOR);
	pinkyName = Screen::getTextSurface(Screen::getLargeFont(), "Penarunqui", Constants::PINKY_COLOR);
	inkyName = Screen::getTextSurface(Screen::getLargeFont(), "Penaroski", Constants::INKY_COLOR);
	clydeName = Screen::getTextSurface(Screen::getLargeFont(), "Pedro", Constants::CLYDE_COLOR);
