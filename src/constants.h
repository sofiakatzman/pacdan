...
public:
	...
	static const int INFO_FRUITS_X = 545; // position (upper left corner) of the level's info fruit
	static const int INFO_FRUITS_Y = 430;
	static const int INFO_FRUITS_DISTANCE = 3; // distance between fruit pictures
	static const int LIVES_X = 545;			   // position (upper left corner) of the lives display
	static const int LIVES_Y = 110;
	static const int LIVES_DISTANCE = 3; // distance between lives pictures
	static const int SCORE_X = 545;		 // position (upper left corner) of the score display
	static const int SCORE_Y = 30;
	static const int SCORE_VALUE_Y = 60;
	static const int LEVEL_X = 545; // position (upper left corner) of the level display
