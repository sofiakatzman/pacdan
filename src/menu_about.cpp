...
MenuAbout::MenuAbout():
	Menu("About")
{
		idea = Screen::getTextSurface(Screen::getLargeFont(), "Happy Birthday", Constants::GRAY_COLOR);
		coding = Screen::getTextSurface(Screen::getLargeFont(), "PAPA!!", Constants::GRAY_COLOR);
		coding2 = Screen::getTextSurface(Screen::getLargeFont(), "I love you, Sofia", Constants::GRAY_COLOR);
		addMenuItem("back");
}
MenuAbout::~MenuAbout() {
